...
public final class Config {
    ...
    public static final String DOMAIN_LOCK = "35.225.103.175"; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "35.225.103.175";
    public static final String QUICKSY_DOMAIN = "35.225.103.175";
